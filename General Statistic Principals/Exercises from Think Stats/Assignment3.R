...
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=height)) + geom_point() + geom_smooth()
## `ed` vs. `earn`
...
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point() + ggtitle("Height vs Earnings") + xlab("height (inches)") + ylab("earn (dollars)")
